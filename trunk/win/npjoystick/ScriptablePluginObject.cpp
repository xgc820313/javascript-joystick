...
ScriptablePluginObject::ScriptablePluginObject(NPP npp) : ScriptablePluginObjectBase(npp), stick() {
	setDevice_id      = methodId[0]  = NPN_GetStringIdentifier("setDevice");
	getDevice_id      = methodId[1]  = NPN_GetStringIdentifier("getDevice");
	isConnected_id    = methodId[2]  = NPN_GetStringIdentifier("isConnected");
	setAutoPoll_id    = methodId[3]  = NPN_GetStringIdentifier("setAutoPoll");
	poll_id           = methodId[4]  = NPN_GetStringIdentifier("poll");
	hasZAxis_id       = methodId[5]  = NPN_GetStringIdentifier("hasZAxis");
	hasRAxis_id       = methodId[6]  = NPN_GetStringIdentifier("hasRAxis");
	hasPOV_id         = methodId[7]  = NPN_GetStringIdentifier("hasPOV");
	getNumButtons_id  = methodId[8]  = NPN_GetStringIdentifier("getNumButtons");
	setButtonA_id     = methodId[9]  = NPN_GetStringIdentifier("setButtonA");
	setButtonB_id     = methodId[10] = NPN_GetStringIdentifier("setButtonB");
	calibrate_id      = methodId[11] = NPN_GetStringIdentifier("calibrate");
	getProductName_id = methodId[12] = NPN_GetStringIdentifier("getProductName");
